package com.avans;//
// Port com.avans.IO emulator class. All read/writes are send over TCP/IP to the host
// using a dedicated protocol on port 81.
// Use com.avans.IO.init(host, port) to modify behaviour
// by Wim Verhoef
...
public class IO {
  ...
  /**
   * Initialize.
   * Before calling the emulated com.avans.IO routines, use one of the init routines
